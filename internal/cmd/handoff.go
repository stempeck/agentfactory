...
func runHandoff(cmd *cobra.Command, args []string) error {
	...
	return runHandoffCore(cmd.Context(), cwd, handoffSubject, handoffMessage, handoffCollect, handoffDryRun)
}

// runHandoffCore contains the core logic for af handoff, separated from cobra for testability.
func runHandoffCore(ctx context.Context, cwd, subject, message string, collect, dryRun bool) error {
	...
	// 8. Clear tmux history and respawn pane
