...
- `af sling --formula <name>` — instantiate a formula (create step beads, resolve DAG, optionally launch); the operator `--input-digest` input-attestation flag is documented in [USING_TOKENOMICS.md](USING_TOKENOMICS.md)
