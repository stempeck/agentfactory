...
Your learnings vault at `.agentfactory/memory/github-issue/` outlives this session, your worktree, and every teardown path — it is the one place durable state survives without operator archaeology.
