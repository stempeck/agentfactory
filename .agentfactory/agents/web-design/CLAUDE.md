<!-- Generated by af formula agent-gen from web-design v2 -->
...
Your learnings vault at `.agentfactory/memory/web-design/` outlives this session, your worktree, and every teardown path — it is the one place durable state survives without operator archaeology.
